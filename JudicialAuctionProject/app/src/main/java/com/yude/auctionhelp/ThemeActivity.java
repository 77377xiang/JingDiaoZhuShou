    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.r_title_tv:
                Toast.makeText(ThemeActivity.this, "我的", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(ThemeActivity.this, MyActivity.class));
            ...
            case R.id.home_tv:
                ...
                tv_2.setTextColor(0xffC82015);
                tv_2.setText("待审核");
                Toast.makeText(ThemeActivity.this, "待审核", Toast.LENGTH_SHORT).show();
                break;
            case R.id.car_tv:
                pager.setCurrentItem(1);
                mPopWindow.dismiss();
                ...
                tv_2.setTextColor(0xffC82015);
                tv_2.setText("已退回");
                Toast.makeText(ThemeActivity.this, "已退回", Toast.LENGTH_SHORT).show();
                break;
            case R.id.factory_home_tv:
                ...
                tv_2.setTextColor(0xffC82015);
                tv_2.setText("上拍");
                Toast.makeText(ThemeActivity.this, " 上拍", Toast.LENGTH_SHORT).show();
                break;
